...
namespace mom {
	...
	protected:
		void		shiftcoordv4(int &sedid, VectorR3 *v4);
		void		shiftcoordv1(int &sedid, VectorR3 &v);
		void		shiftcoordv3(int &sedid, VectorR3 *v3);

		void		shiftcoordv4(int &xid, int &yid, VectorR3 *v4);
		void		shiftcoordv3(int &xid, int &yid, VectorR3 *v3);
		void		shiftcoordv1(int &xid, int &yid, VectorR3 &v);

		void		shiftbedgecoordv4(int &bedge, VectorR3 *v4);
		void		shiftbedgecoordv3(int &bedge, VectorR3 *v3);
		void		shiftbedgecoordv1(int &bedge, VectorR3 &v);
	...
	inline VectorR3 NEWSED_SPIN::centerv4(VectorR3 *v4)
	{
		return (v4[0] + v4[1] + v4[2] + v4[3]) / 4.0f;
	}

	inline VectorR3 NEWSED_SPIN::centerv3(VectorR3 *v3)
	{
