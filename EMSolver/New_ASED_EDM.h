...
namespace mom {
	...
	protected:
		Complex		DDEDMFFKernel(VectorR3 *vf_p4,VectorR3 *vf_m4, VectorR3 *vs_p4, VectorR3 *vs_m4, value_t &a_fld,value_t &a_src, value_t &eps_s);
		Complex		DDEDMFHKernel(VectorR3 *vf_p4, VectorR3 *vf_m4, VectorR3 *vs_4, VectorR3 *vs_ct3, value_t &a_fld, value_t &a_src, value_t &eps_s);
		Complex		DDEDMHFKernel(VectorR3 *vf_4, VectorR3 *vf_ct3, VectorR3 *vs_p4, VectorR3 *vs_m4, value_t &a_fld, value_t &a_src, value_t &eps_s);
		Complex		DDEDMHHKernel(VectorR3 *vf_4, VectorR3 *vf_ct3, VectorR3 *vs_4, VectorR3 *vs_ct3, value_t &a_fld, value_t &a_src, value_t &eps_s);

		Complex		DMEDMFFKernel(VectorR3 *vf_p4, VectorR3 *vf_m4, VectorR3 *vs_p3, VectorR3 *vs_m3, value_t &a_fld, value_t &l_src);
		Complex		DMEDMHFKernel(VectorR3 *vf_4, VectorR3 *vf_ct3, VectorR3 *vs_p3, VectorR3 *vs_m3, value_t &a_fld, value_t &l_src);

		Complex		MDEDMFFKernel(VectorR3 *vf_p3, VectorR3 *vf_m3, VectorR3 *vs_p4, VectorR3 *vs_m4, value_t &l_fld, value_t &a_src, value_t &eps_s);
		Complex		MDEDMFHKernel(VectorR3 *vf_p3, VectorR3 *vf_m3, VectorR3 *vs_p4, VectorR3 *vs_ct3, value_t &l_fld, value_t &a_src, value_t &eps_s);
	...
	inline VectorR3 New_ASED_EDM::centerv4(VectorR3 *v4)
	{
		return (v4[0] + v4[1] + v4[2] + v4[3]) / 4.0f;
	}

	inline VectorR3 New_ASED_EDM::centerv3(VectorR3 *v3)
	{
