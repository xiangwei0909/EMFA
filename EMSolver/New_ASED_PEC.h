...
namespace mom {
	...
	protected:
		...
		std::vector<int> Task_assign1, Task_assign2, Task_assign3;
	...
	inline VectorR3 New_ASED_PEC::centerv4(VectorR3 *v4)
	{
		return (v4[0] + v4[1] + v4[2] + v4[3]) / 4.0f;
	}

	inline VectorR3 New_ASED_PEC::centerv3(VectorR3 *v3)
	{
