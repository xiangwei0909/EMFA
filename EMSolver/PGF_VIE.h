...
protected:
	...
	//Complex		HZpmKernel(VectorR3 *vf4, VectorR3 *vs4, VectorR3 &vf, VectorR3 &vs, VectorR3 *vf3, VectorR3 *vs3, int &t_f, int &t_s, value_t eps_f, value_t eps_s);
	//Complex		HZmpKernel(VectorR3 *vf4, VectorR3 *vs4, VectorR3 &vf, VectorR3 &vs, VectorR3 *vf3, VectorR3 *vs3, int &t_f, int &t_s, value_t eps_f, value_t eps_s);
	//Complex		HZmmKernel(VectorR3 *vf4, VectorR3 *vs4, VectorR3 &vf, VectorR3 &vs, VectorR3 *vf3, VectorR3 *vs3, int &t_f, int &t_s, value_t eps_f, value_t eps_s);
